...
const MenuIcon = forwardRef((props, ref) => {
  ...
  return (
    <StyledMenuIcon
      ref={ref}
      title={t('RESPONSE_PANE.RESPONSE_PANE_ACTIONS.MORE_ACTIONS')}
      {...props}
    >
...
const ResponsePaneActions = ({ item, collection, responseSize, selectedFormat, selectedTab, data, dataBuffer }) => {
  ...
  const gqlMenuItems = [
    {
      id: 'copy-response',
      label: t('RESPONSE_PANE.RESPONSE_PANE_ACTIONS.COPY_RESPONSE'),
    ...
    },
    {
      ...
      label: t('RESPONSE_PANE.RESPONSE_PANE_ACTIONS.DOWNLOAD_RESPONSE'),
    ...
    {
      id: 'clear-response',
      label: t('RESPONSE_PANE.RESPONSE_PANE_ACTIONS.CLEAR_RESPONSE'),
    ...
    {
      id: 'change-layout',
      label: t('RESPONSE_PANE.RESPONSE_PANE_ACTIONS.CHANGE_LAYOUT'),
  ...
  const menuItems = [
    ...
    {
      id: 'save-response',
      label: t('RESPONSE_PANE.RESPONSE_PANE_ACTIONS.SAVE_RESPONSE'),
