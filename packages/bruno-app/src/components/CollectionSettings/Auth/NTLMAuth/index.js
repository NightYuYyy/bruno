...
const NTLMAuth = ({ collection }) => {
  ...
  return (
    <StyledWrapper className="mt-2 w-full">
      <label className="block mb-1">{t('COLLECTION_SETTINGS.AUTH.USERNAME')}</label>
      ...
      <label className="block mb-1">{t('COLLECTION_SETTINGS.AUTH.PASSWORD')}</label>
      ...
      <label className="block mb-1">{t('COLLECTION_SETTINGS.AUTH.DOMAIN')}</label>
