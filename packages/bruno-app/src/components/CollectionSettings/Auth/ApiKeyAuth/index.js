...
const ApiKeyAuth = ({ collection }) => {
  ...
  return (
    <StyledWrapper className="mt-2 w-full">
      <label className="block mb-1">{t('COLLECTION_SETTINGS.AUTH.KEY')}</label>
      ...
      <label className="block mb-1">{t('COLLECTION_SETTINGS.AUTH.VALUE')}</label>
      <div className="single-line-editor-wrapper mb-3">
        <SingleLineEditor
      ...
      <label className="block mb-1">{t('COLLECTION_SETTINGS.AUTH.ADD_TO')}</label>
      <div className="inline-flex items-center cursor-pointer auth-placement-selector w-fit">
        <Dropdown onCreate={onDropdownCreate} icon={<Icon />} placement="bottom-end">
          ...
          >
            {t('COLLECTION_SETTINGS.AUTH.HEADER')}
          </div>
          <div
            className="dropdown-item"
            onClick={() => {
          ...
          >
            {t('COLLECTION_SETTINGS.AUTH.QUERY_PARAMS')}
          </div>
        </Dropdown>
      </div>
    </StyledWrapper>
