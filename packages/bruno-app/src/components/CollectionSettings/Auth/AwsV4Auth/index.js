...
const AwsV4Auth = ({ collection }) => {
  ...
  return (
    <StyledWrapper className="mt-2 w-full">
      <label className="block mb-1">{t('COLLECTION_SETTINGS.AUTH.ACCESS_KEY_ID')}</label>
      ...
      <label className="block mb-1">{t('COLLECTION_SETTINGS.AUTH.SECRET_ACCESS_KEY')}</label>
      ...
      <label className="block mb-1">{t('COLLECTION_SETTINGS.AUTH.SESSION_TOKEN')}</label>
      <div className="single-line-editor-wrapper mb-3">
        <SingleLineEditor
      ...
      <label className="block mb-1">{t('COLLECTION_SETTINGS.AUTH.SERVICE')}</label>
      <div className="single-line-editor-wrapper mb-3">
        <SingleLineEditor
      ...
      <label className="block mb-1">{t('COLLECTION_SETTINGS.AUTH.REGION')}</label>
      <div className="single-line-editor-wrapper mb-3">
        <SingleLineEditor
      ...
      <label className="block mb-1">{t('COLLECTION_SETTINGS.AUTH.PROFILE_NAME')}</label>
