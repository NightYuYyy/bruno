...
const ClientCertSettings = ({ collection }) => {
  ...
  return (
    <StyledWrapper className="w-full h-full">
      <div className="text-xs mb-4 text-muted">{t('COLLECTION_SETTINGS.CLIENT_CERT.DESCRIPTION')}</div>

      <h1 className="font-medium">{t('COLLECTION_SETTINGS.CLIENT_CERT.CLIENT_CERTIFICATES')}</h1>
      <ul className="mt-4">
        {!clientCertConfig.length
          ? t('COLLECTION_SETTINGS.CLIENT_CERT.NO_CERTIFICATES')
      ...
      <h1 className="font-medium mt-8 mb-2">{t('COLLECTION_SETTINGS.CLIENT_CERT.ADD_CLIENT_CERTIFICATE')}</h1>
      <form className="bruno-form" onSubmit={formik.handleSubmit}>
          ...
          <div className="flex items-center" aria-labelledby="type-label">
            <label className="flex items-center cursor-pointer" htmlFor="cert">
              <input
                ...
                className="mr-1"
              />
              {t('COLLECTION_SETTINGS.CLIENT_CERT.CERT')}
            </label>
          ...
          <>
            <div className="mb-3 flex items-center">
              <label className="settings-label" htmlFor="certFilePath">
                {t('COLLECTION_SETTINGS.CLIENT_CERT.CERT_FILE')}
              </label>
            ...
            <div className="mb-3 flex items-center">
              <label className="settings-label" htmlFor="keyFilePath">
                {t('COLLECTION_SETTINGS.CLIENT_CERT.KEY_FILE')}
              </label>
          ...
          <>
            <div className="mb-3 flex items-center">
              <label className="settings-label" htmlFor="pfxFilePath">
                {t('COLLECTION_SETTINGS.CLIENT_CERT.PFX_FILE')}
              </label>
              <div className="flex flex-row gap-2">
                <input
                  key="pfxFilePath"
        ...
        <div className="mt-6 flex flex-row gap-2 items-center">
          <Button type="submit" size="sm" data-testid="add-client-cert">
            {t('COLLECTION_SETTINGS.CLIENT_CERT.ADD')}
          </Button>
