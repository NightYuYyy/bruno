        ...
        <div className="card shadow-sm rounded-md p-4 w-[600px]">
          <div>
            <div className="font-medium flex items-center gap-2 pb-4">
              ...
              {t('REQUEST_IS_LOADING.FILE_INFO')}
            </div>
            <div className="hr" />

            <div className="flex items-center mt-2">
              <span className="w-12 mr-2 text-muted">{t('REQUEST_IS_LOADING.NAME')}</span>
              <div>
                {item?.name}
              </div>
            </div>
            ...
            <div className="flex items-center mt-1">
              <span className="w-12 mr-2 text-muted">{t('REQUEST_IS_LOADING.PATH')}</span>
            ...
            <div className="flex items-center mt-1 pb-4">
              <span className="w-12 mr-2 text-muted">{t('REQUEST_IS_LOADING.SIZE')}</span>
              <div>
            ...
            <div className="flex items-center gap-2 mt-4">
              ...
              <span>{t('REQUEST_IS_LOADING.LOADING')}</span>
            </div>
          </div>
        </div>
      </div>
